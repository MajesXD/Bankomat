...
if quota > acc_balance:
    ...
    def spr_200(quota_operation):
        ...
        if amount_200 <= quantity and amount_200 > 0:
            ...
            take_200 = quantity
            print('do zabrania 200x ' + str(take_200))
        ...
        #Jeśli w bazie jest więcej banknotów
            ...
            quota_operation = quota_operation - value
            take_200 = quantity
            print('do zabrania 200y ' + str(take_200))
    ...
    value, quota_operation, take_100, amount_100 = spr_100(quota_operation)
    value, quota_operation, take_50, amount_50 = spr_50(quota_operation)
    value, quota_operation, take_20, amount_20 = spr_20(quota_operation)
    value, quota_operation, take_10, amount_10 = spr_10(quota_operation)
